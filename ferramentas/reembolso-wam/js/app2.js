$(document).ready(function() {
  ...
  const empreendimentos = [
    ...
    'GAV VACATION CLUB (PONTOS)', 'GRAN GARDEN RESORT', 'GRAN HAUS RESORT',
    'GRAN VALLEY RESORT', 'HOTEL DOM PEDRO LAGUNA', 'HOTEL FAZENDA CHINA PARK',
    'ILHAS DO LAGO ECO RESORT', 'JERIQUIÁ DUNAS RESORT', 'JERIQUIÁ LAGOA RESORT',
    'KAWANA RESIDENCE', 'LE CHARMANT MAISON DE LUXE', 'MAGIC HOME RESIDENCE PARK',
    'MANDALA DOS PIRINEUS ECO VILLAGE', 'OIKOS MARAGOGI RESORT', 'OLÍMPIA PARK RESORT',
    'ONDAS PRAIA RESORT', 'PORTO 2 LIFE RESORT', 'PORTO ALTO RESORT',
    'PRAIAS DO LAGO ECO RESORT', 'PYRENÉUS RESIDENCE', 'REFÚGIO DAS LONTRAS',
    'RESORT DO LAGO', 'SALINAS BEACH RESORT', 'SOLAR DAS ÁGUAS PARK RESORT',
    'TERRA NOVA ONDAS RESORT', 'TREE BIES BEACH RESORT', 'WVC TIME SHARE'
  ];
  ...
  const STATUS_CFG = {
    'Efetivado':        { fg: '#006800', bg: '#e6f4ea', icone: 'check',   origem: 'Processamento concluído com sucesso.',        fluxo: 'Reembolso Finalizado',                fluxoIcone: 'check',   fluxoFg: VERDE,     rodape: 'O valor foi creditado na forma selecionada.' },
    'Aprovado':         { fg: '#006800', bg: '#e6f4ea', icone: 'check',   origem: 'Solicitação aprovada pelo setor financeiro.', fluxo: 'Crédito Aprovado',                    fluxoIcone: 'check',   fluxoFg: VERDE,     rodape: 'O valor será creditado em breve.' },
    'Concluído':        { fg: '#006800', bg: '#e6f4ea', icone: 'check',   origem: 'Processamento finalizado.',                   fluxo: 'Reembolso Concluído',                 fluxoIcone: 'check',   fluxoFg: VERDE,     rodape: 'O valor foi creditado na forma selecionada.' },
    'Estornado':        { fg: '#006800', bg: '#e6f4ea', icone: 'check',   origem: 'Estorno processado com sucesso.',             fluxo: 'Estorno Finalizado',                  fluxoIcone: 'check',   fluxoFg: VERDE,     rodape: 'O valor foi estornado na forma original.' },
