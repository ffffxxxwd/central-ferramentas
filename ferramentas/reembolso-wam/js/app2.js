$(document).ready(function() {
  ...
  const empreendimentos = [
    'BÚZIOS FRACTIONAL RESORT', 'CONDOMÍNIO CHALÉ', 'DOM PEDRO LAGUNA',
    'ENCONTRO DAS ÁGUAS', 'HOTEL FAZENDA CHINA PARK', 'ILHAS DO LAGO ECO RESORT',
    'KAWANA RESIDENCE', 'LE CHARMANT', 'MAGIC HOME RESIDENCE PARK',
    'MANDALA DOS PIRINEUS ECO VILLAGE', 'OLÍMPIA PARK RESORT', 'ONDAS PRAIA RESORT',
    'PRAIAS DO LAGO ECO RESORT', 'REFÚGIO DAS LONTRAS', 'RESORT DO LAGO',
    'SOLAR DAS ÁGUAS PARK RESORT', 'TERRA NOVA ONDAS RESORT',
    'TREE BIES BEACH RESORT', 'WVC TIME SHARE'
  ];
