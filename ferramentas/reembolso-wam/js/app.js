$(document).ready(function() {
  ...
  // Mesma lista de empreendimentos do formulário principal
  ...
  const AVISO_OK = 'O valor foi creditado <strong>instantaneamente</strong> na forma selecionada. Guarde este comprovante e o número de protocolo para acompanhamento.';
  ...
  const STATUS_CFG = {
    'Efetivado':        { fg: '#0b7a33', bg: '#e6f4ea', icone: 'check',   titulo: 'Reembolso efetivado',        aviso: AVISO_OK },
    'Aprovado':         { fg: '#0b7a33', bg: '#e6f4ea', icone: 'check',   titulo: 'Reembolso aprovado',         aviso: AVISO_OK },
    'Concluído':        { fg: '#0b7a33', bg: '#e6f4ea', icone: 'check',   titulo: 'Reembolso concluído',        aviso: AVISO_OK },
    'Estornado':        { fg: '#0b7a33', bg: '#e6f4ea', icone: 'check',   titulo: 'Reembolso estornado',        aviso: AVISO_OK },
